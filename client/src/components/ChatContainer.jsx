...
const ChatContainer = () => {
    ...
    return selectedUser ? (
        <div className=' flex flex-col h-full overflow-scroll relative backdrop-blur-lg'>
            ...
            {/* ------------------ bottom area  -----------------------------*/}
            <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 shrink-0 p-3 '>
                <div className='flex flex-1 items-center bg-gray-100/12 px-3 rounded-full'>
                    ...
                    <label htmlFor="image">
                        <img src={assets.gallery_icon} alt="" className='w-5 mr-2 cursor-pointer hover:opacity-80 transition-opacity' />
                    </label>
                </div>
